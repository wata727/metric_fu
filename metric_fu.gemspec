...
Gem::Specification.new do |s|
  ...
  # s.add_dependency("chronic", ["~> 0.3.0"])  # This causes a version conflict. It should not be here, because metric_fu itself does not seem to use chronic. Rubygems will pick up the correct dependency from churn (>= 0.2.3) and main (~> 0.6.2)
